...
def generate_page(from_path: str, template_path: str, dest_path: str) -> None:
    ...
    page = templace.replace("{{ Title }}", title).replace("{{ Content }}", htmlString)
...
def generate_pages_recurvise(dir_path_content: str, template_path: str, dest_dir_path: str) -> None:
    for name in os.listdir(dir_path_content):
        ...
        if os.path.isfile(from_path):
            ...
            generate_pages_recurvise(from_path, template_path, dest_path)
